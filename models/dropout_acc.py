...
from models.model_run_acc import drop_cmp_mthds
import torch
import os
import scipy.io as io


def run_drop(param_config: ParamConfig):
    """
    ...
    for i in torch.arange(len(param_config.dataset_list)):
        ...
        for kfold_idx in torch.arange(param_config.n_kfolds):
            ...
            cnn11_valid_acc, cnn12_valid_acc, cnn21_valid_acc, cnn22_valid_acc = \
                drop_cmp_mthds(param_config, train_data, test_data, kfold_idx)
        ...
        data_save_file = f"{data_save_dir}/acc_fpn_drop_{param_config.dataset_folder}" \
                         f"_rule{param_config.n_rules}_nl_{param_config.noise_level}_drop_{param_config.drop_rate}" \
